...
public class Recommendation {
    ...
    /**
     * developer, nationality, currentproject, earlieststart,
     * estimateworkingday, estimateday, scheduleperformance, estimatecompletion,
     * idealcompletion, defectlessfactor, schedulefactor, avgdefectperproject,
     * experiencefactor, projectcount, zainessscore, sorting
     *
     */
    ...
    /**
     * The number of ongoing projects that a developer is partaking for the
     * given planned start and end date.
     *
     * @return
     */
     ...
     *
     *
     * The earliest date that a developer can start on a new project. This is 1
     * day after the end date of the last project.
     *
     * @return
     */
    ...
    /**
     *
     * The estimated working days a developer need to complete a project of a
     * fixed size based on his timeliness score working on projects of the
     * similar type.
     *
     * @return
     */
    ...
    /**
     *
     * The estimated completion date based on developer's timeliness of past
     * project of the same type, weekend is accounted for.
     *
     * @return
     */
    ...
    /**
     *
     * The ideal completion date for this developer to complete the project
     * based on the number of day a PM estimated for that project based on
     * functionalities.
     *
     * @return
     */
    ...
    /**
     *
     * The defect score for a developer based on the developer past defect
     * history that take into account the severity of the defects and deduct
     * points based on: high=-3, mid=-2, low=-1. The score is normalize as the a
     * percentile(p-value) based on a normal distribution(Z-table).
     *
     * @return
     */
    ...
    /**
     *
     * A log function of the Schedule Performance to represent timeliness of
     * developer for a specific type of project. e.g 0 is worse. 1 is best.
     *
    ...
    /**
     *
     * The experience score of a developer. 0 is worse. 1 is best. We use a
     * formula similar to Amdahl's law to represent developer experience score
     * leveling off after 10 standard project(20points). e.g High=3points
     * Mid=2points Low=1points 20point = experience factor=0.8
     *
     * @return
     */
    ...
    /**
     *
     * The number of project of the similar type that a developer have
     * completed.
     *
     * @return
     */
    ...
    /**
     *
     * A score based on 3 the weighted(33% each) average of 3 factors to get the
     * most "Zai" developer to take on high priority project: Skillset,
     * Timeliness,low defects, High experience.
     *
     * @return
     */
    ...
    /**
     *
     * The ranking order of the list of recommendation, 1 is based on "zainess"
     * and 0 is based on earliest estimated completion date.
     *
     * @return
     */
