<%-- 
    Document   : addUsers
    Created on : Oct 23, 2015, 6:48:40 PM
    Author     : maxchua
--%>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#role').change(function () {
                    ...
                    if ($('#role').val() != 'c') { //if this value is NOT selected
        ...
        <section id="main-content">
                            ...
                            <div class="panel-body">
                                <form action='addNewUser' method='POST'id='main'>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="username" required class="form-control" id="inputEmail1" placeholder="Name">
                                            <p></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="trellokey" required class="form-control" id="inputPassword1" placeholder="Trello Key"><p></p>
                                        </div>
                                        <label for="inputPassword1" class="col-lg-2 control-label">Trello Token</label>
                                        <div class="col-lg-9">
                                            <input type="text" name="trellotoken" required class="form-control" id="inputPassword1" placeholder="Trello Token"><p></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
            ...
            <!--        <h1>Add a new user to the system</h1>
                    ...
                    <form action='addNewUser' method='POST'id='main'>
                        ...
                        Trello Key: <input type='text' name='trellokey'/></br>
                        Trello Token: <input type='text' name='trellotoken'/></br>
            
                        <div id='devOnly'>
                            Employment Date: <input type='date' name='eDate'/></br>
